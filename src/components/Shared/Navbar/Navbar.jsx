    ...
    return (
        <div className='d-flex justify-content-around py-3 text-bg-dark align-items-center'>
            ...
            <div className='fs-4'>
                ...
                <Link className='px-3 text-decoration-none text-white'>Instructors</Link>
                <Link className='px-3 text-decoration-none text-white'>Classes</Link>
                <Link className='px-3 text-decoration-none text-white'>Dashboard</Link>
            </div>
            <div>
