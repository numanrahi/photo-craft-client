...
const AdminSingleUser = ({ single, setTest }) => {
  ...
  fetch("https://assgignment-12-server.vercel.app/all-users/update-role", {
    method: "PATCH",
    headers: {
  ...
  return (
    <div>
      <div className="row align-items-center justify-content-between border-class rounded-5 my-5">
        <div className="col-4">
          <img
            src={image}
            alt="user image"
