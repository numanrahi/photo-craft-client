    ...
    <div>
      ...
      <div className="my-3">
        ...
        <div className="d-flex align-items-center">
          <img
            className=" w-50"
            src="https://media.istockphoto.com/id/1456365976/vector/two-factor-authentication-line-vector-illustration.jpg?s=612x612&w=0&k=20&c=rTw0hwGBCWabdlfptPEtUBn4_2iW2vAlgxFeFNYmpMk="
            alt=""
          />
